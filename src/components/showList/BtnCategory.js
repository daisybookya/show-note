...
const BtnCategory = (props:{dataList:Object,handleBtnValue:Function,defaultValue:String}) => {
    ...
    return ( 
        <div>
            <Radio.Group buttonStyle="solid" defaultValue={initValue} onChange={handleBtnChange}>
            {
                items.map((btn,index)=>{
